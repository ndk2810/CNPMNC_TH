            ...
            <div>
                <form className="box-tourDat">
                    ...
                    <div className="box-tourDat-body">
                        <h4 className="pd">[GIẢM 17%] Ăn tối trên sông Sài Gòn - Tour đêm</h4>
                        ...
                        <div className="box-tourDat-chiTietTour pd">
                            ...
                            <p style={{ fontWeight: 600 }}>[GIẢM 17%] Tour ghép dành cho tối đa 12 khách</p>
                        </div>
                        ...
                        <div className="box-tourDat-thongTinTour pd">
                            <table>
                                <tr>
                                    ...
                                    <td className="box-tourDat-thongTinTour-value">Thứ 4, 2 thg 6 2021</td>
                                </tr>
                                <tr>
                                    <td>Khung thời gian</td>
                                    <td className="box-tourDat-thongTinTour-value">18:30</td>
                                </tr>
                                <tr>
                                    <td>Áp dụng cho</td>
                                    <td className="box-tourDat-thongTinTour-value">2 Người lớn</td>
                                </tr>
                            </table>
                        </div>
                    </div>
